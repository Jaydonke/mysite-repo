...
img = Image.open('D:\\chrome download\\as-master\\favicon_io\\site-theme.png.temp2').convert('RGBA')
pixels = img.load()
...
img.save('D:\\chrome download\\as-master\\favicon_io\\site-theme.png', 'PNG', optimize=True)
